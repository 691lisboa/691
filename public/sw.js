...
const STATIC_ASSETS = [
  ...
  '/destination-page.js',
  '/taxi-lisboa/',
  '/taxi-aeroporto-lisboa/',
  '/lisbon-airport-taxi/',
  '/viagens-portugal/',
  '/viagens-portugal/sintra/',
  '/viagens-portugal/fatima/',
  '/viagens-portugal/nazare/',
  '/viagens-portugal/porto/',
  '/viagens-portugal/evora/',
  '/assets/taxi-691.webp',
  '/assets/taxi-691-mobile.webp',
  '/assets/destinations/lisboa.webp',
  '/assets/destinations/lisboa-mobile.webp',
  '/assets/destinations/sintra.webp',
  '/assets/destinations/sintra-mobile.webp',
  '/assets/destinations/fatima.webp',
  '/assets/destinations/fatima-mobile.webp',
  '/assets/destinations/nazare.webp',
  '/assets/destinations/nazare-mobile.webp',
  '/assets/destinations/porto.webp',
  '/assets/destinations/porto-mobile.webp',
  '/assets/destinations/evora.webp',
  '/assets/destinations/evora-mobile.webp',
  '/offline.html',
  '/offline.css',
  '/offline.js',
  '/legal.html',
